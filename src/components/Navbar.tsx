...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 border-b border-white/10 bg-gray-950/80 backdrop-blur-md">
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-white/10 bg-gray-950 px-6 pb-4 pt-3 flex flex-col gap-3 text-sm font-medium text-gray-300">
          ...
          <Link href="/signup" className="rounded-lg bg-violet-600 px-4 py-2 text-center text-white font-semibold hover:bg-violet-500 transition-colors">Get started</Link>
        </div>
      )}
    </nav>
  );
